...
Elm.Board.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Note = Elm.Note.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var addStyles = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                        ,_0: "position"
                                                        ,_1: "fixed"}
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "top"
                                  ...
                                  return function () {
                                     ...
                                     {case "_Tuple2":
                                        return !_U.eq(_v8._0,
                                          action._0);}
                                     _U.badCase($moduleName,
                                     "on line 40, column 55 to 67");
                                  }();
                               },
                               model.notes)]],
              model);}
         _U.badCase($moduleName,
         "between lines 31 and 49");
      }();
   });
   ...
   var viewNote = F2(function (address,
   _v12) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return function () {
                 var context = A2($Note.Context,
                 A2($Signal.forwardTo,
                 address,
                 Modify(_v12._0)),
                 A2($Signal.forwardTo,
   ...
   model) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.$class("btn btn-sm btn-success glyphicon glyphicon-plus")
         ...
         _L.fromArray([]));
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("board")]),
         A2($List._op["::"],
         insert,
         A2($List.map,
         viewNote(address),
...
Elm.Note = Elm.Note || {};
Elm.Note.make = function (_elm) {
   "use strict";
   _elm.Note = _elm.Note || {};
   if (_elm.Note.values)
   return _elm.Note.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var noteStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                        ,_0: "height"
                                                        ,_1: "150px"}
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "width"
                                                       ...
                                                       ,{ctor: "_Tuple2"
                                                        ...
                                                        ,_1: "5px 5px 15px 0 rgba(0, 0, 0, .2)"}
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "box-shadow"
                                                        ,_1: "5px 5px 15px 0 rgba(0, 0, 0, .2)"}]));
   ...
   var UpdateNote = F2(function (a,
   b) {
      return {ctor: "UpdateNote"
             ,_0: a
             ,_1: b};
   });
   var EditingNote = function (a) {
      return {ctor: "EditingNote"
             ,_0: a};
   };
   ...
   model) {
      ...
      _L.fromArray([A2($Html.p,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(model.body)]))
                   ,A2($Html.span,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.button,
                                _L.fromArray([A2($Html$Events.onClick,
                                             context.actions,
                                             EditingNote(true))
                                             ,$Html$Attributes.$class("btn btn-primary glyphicon glyphicon-pencil")
                                ...
                                _L.fromArray([A2($Html$Events.onClick,
                                             context.remove,
                                             {ctor: "_Tuple0"})
                                             ,$Html$Attributes.$class("btn btn-danger glyphicon glyphicon-trash")
                                             ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                   ,_0: "margin"
                                                                                   ,_1: "2px"}]))]),
                                _L.fromArray([]))]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.$class("edit form-control")
                                ...
                                function ($) {
                                   return $Signal.message(context.actions)(UpdateNote(model.id)($));
                                })
